...
const SCENARIOS = [
  ...
  { q: '長頭髮的同學使用手電鑽，應該怎麼處理？', a: '小心一點就好', b: '必須先綁起來、塞進帽子或衣領裡', correct: 'b', explain: '手電鑽轉速可達 2000 RPM，頭髮一捲入就會被瞬間扯入夾頭，造成頭皮撕裂。長髮、寬鬆袖口、項鍊、圍巾都要先處理。' },
  ...
  { q: '想鑽金屬板，應該選哪種鑽頭？', a: '木工螺旋鑽頭', b: '高速鋼（HSS）鑽頭', correct: 'b', explain: '木工鑽頭有「中心尖」，鑽金屬會立刻崩刃還會打滑。鑽金屬一定要用 HSS 或鈷鋼鑽頭，並先用中心衝打點防止偏鑽。' },
  { q: '鑽到一半鑽頭卡住，正確處置？', a: '繼續用力推，硬鑽過去', b: '鬆開扳機 → 切到反轉 → 慢慢退出', correct: 'b', explain: '硬鑽會折斷鑽頭甚至燒馬達。卡鑽多半是進刀過快或鑽頭鈍了，要退出來檢查再繼續。深孔每鑽一段就退一次排屑。' },
  { q: '剛鑽完的金屬鑽頭，多久能徒手摸？', a: '立刻能摸', b: '等 1–2 分鐘冷卻後才能摸', correct: 'b', explain: '鑽金屬時鑽頭尖端溫度可達 200°C 以上，徒手摸會嚴重燙傷。要等冷卻或先用濕布降溫。' },
  ...
  { q: '想鎖一顆小螺絲到 MDF 板，扭力環應該怎麼設定？', a: '直接用最大鑽孔模式', b: '設定到中低段（約 4–8），離合器會在到位時跳脫', correct: 'b', explain: '鑽孔模式會把螺絲鎖到斷頭或把板材鎖裂。鎖螺絲要用離合器模式：扭力一夠就跳脫，不會過鎖。' },
  ...
  { q: '鑽完孔，要把鑽頭從夾頭取下，正確程序？', a: '直接轉開夾頭就好', b: '先檢查鑽頭已停止旋轉 → 拆電池 → 反轉夾頭環取下', correct: 'b', explain: '取鑽頭時若誤觸扳機，鑽頭會旋轉割傷手指。安全的做法是先拆電池斷電，徹底切斷誤觸發風險。' },
];
let score = 0;
