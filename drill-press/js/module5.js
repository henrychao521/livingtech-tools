...
const FAULTS = [
  ...
  { name: '工件飛起（Workpiece Ejection）', symptom: '鑽孔中工件被鑽頭咬住高速旋轉，從工作檯飛出傷人。', cause: '工件沒固定（徒手按）、小工件用手按、夾具沒鎖緊。', fix: '所有工件必須用機台老虎鉗或 C 型夾固定到工作檯。小工件特別容易被甩飛。', icon: '✈', color: '#dc2626' },
  ...
  { name: '鑽穿工作檯（Table Damage）', symptom: '鑽穿工件後鑽頭直接打到工作檯，留下永久傷痕。', cause: '工件下方沒墊犧牲層、進刀深度沒設限位。', fix: '永遠在工件下墊「廢木板」、用「進刀深度限位環」設定鑽到工件厚度 +2mm 自動停。', icon: '🪛', color: '#a16207' },
...
const QUIZ_CASES = [
  ...
  { situation: '鑽 8mm 不鏽鋼，學生看皮帶在最高速段位，鑽下去後孔周冒煙、有焦味。', options: ['過熱燒孔', '鑽頭斷裂', '皮帶打滑'], correct: 0, explain: '過熱燒孔——鋼要用最低速 + 切削油，學生用了最高速。' },
  { situation: '鑽完 5mm 木板後鑽頭繼續下降，工作檯多了一道凹痕。', options: ['偏鑽', '鑽穿桌面', '鑽頭斷裂'], correct: 1, explain: '鑽穿桌面——工件下方沒墊犧牲層、進刀深度沒設限位環。' },
  { situation: '深孔鑽到一半，鑽頭突然「啪」一聲斷成兩半，半截卡在工件內。', options: ['鑽頭斷裂', '夾頭沒鎖緊', '皮帶打滑'], correct: 0, explain: '鑽頭斷裂——進刀太猛、沒退屑、鑽頭已鈍。深孔每 5mm 要退鑽一次排屑。' },
];
