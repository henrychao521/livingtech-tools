...
const SCENARIOS = [
  ...
  { q: '想鑽一塊小金屬片，工件可以用手按住嗎？', a: '小心一點按住就可以', b: '絕對不行！要用機台老虎鉗或 C 型夾固定在工作檯上', correct: 'b', explain: '小工件最容易被鑽頭咬住甩起來變「飛刀」。鑽床扭力大，徒手按住的工件會直接被扯飛，手指可能被切傷。' },
  ...
  { q: '長頭髮的同學要操作鑽床，怎麼處理？', a: '把頭髮塞進衣領就好', b: '必須先綁起來，最好加戴髮網或鴨舌帽', correct: 'b', explain: '鑽床主軸轉速 500–2400 RPM，頭髮一捲入就會被瞬間扯入夾頭。長髮、寬鬆袖口、項鍊、圍巾、領帶都要先處理。' },
  { q: '操作鑽床時可以戴布手套嗎？', a: '可以，比較不會手痠', b: '禁止！手套容易被夾頭捲入', correct: 'b', explain: '布手套被夾頭咬住會把整隻手扯進去——這比沒戴手套還危險。鑽床（與所有旋轉機具）操作禁戴手套。' },
  { q: '工件下方應該怎麼處理才能保護工作檯？', a: '直接放在工作檯上鑽', b: '墊一塊「廢木板」當犧牲層', correct: 'b', explain: '鑽穿瞬間鑽頭會繼續往下，沒墊犧牲層會直接鑽進工作檯造成傷害。墊木塊也能減少工件底面爆裂。' },
  { q: '鑽到鐵屑卡在鑽頭周圍，要怎麼清？', a: '用手撥開', b: '停機 → 等鑽頭完全停止 → 用毛刷或鉤子清', correct: 'b', explain: '高速鐵屑像小刀片一樣銳利且燙手，徒手清會割傷+燙傷。停機後仍要等慣性轉完才能伸手。' },
  { q: '進刀時感覺異常吃力（鑽不下去），可能是？', a: '繼續用力推穿過去', b: '停機檢查——可能鑽頭鈍了或卡屑了，要退鑽排屑', correct: 'b', explain: '硬推會折斷鑽頭、傷工件、燒馬達。鑽不動通常代表鑽頭鈍、屑塞滿、轉速錯、或進到硬點——退出來檢查。' },
  { q: '主軸開始轉動後發現工件沒夾穩，怎麼辦？', a: '快速調整一下', b: '立刻關機、等主軸完全停止後再處理', correct: 'b', explain: '主軸轉動中接近工件區會被夾頭、鑽頭、皮帶捲入。任何調整都必須在停機後做。' },
  { q: '鑽完孔結束操作，最後一步？', a: '直接離開', b: '關機 → 等主軸停止 → 拆下鑽頭 → 清理鐵屑 → 把夾頭鑰匙歸位', correct: 'b', explain: '收尾清理是基本禮儀也是安全：留在夾頭上的鑽頭，下一個同學可能誤觸開關被刺傷；散落的鐵屑可能割人。' },
];
let score = 0;
