...
const SCENARIOS = [
  ...
  { q: '想鑽一塊小金屬片，工件可以用手按住嗎？', a: '絕對不行！要用機台老虎鉗或 C 型夾固定在工作台上', b: '小心一點按住就可以', correct: 'a', explain: '小工件最容易被鑽頭咬住甩起來變「飛刀」。鑽床扭力大，徒手按住的工件會直接被扯飛，手指可能被切傷。' },
  ...
  { q: '工件下方應該怎麼處理才能保護工作台？', a: '墊一塊「廢木板」當犧牲層', b: '直接放在工作台上鑽', correct: 'a', explain: '鑽穿瞬間鑽頭會繼續往下，沒墊犧牲層會直接鑽進工作台造成傷害。墊木塊也能減少工件底面爆裂。' },
  ...
  { q: '要在圓柱形木棒上鑽孔，如何固定在工作台上？', a: '用 V 型槽固定塊（V-block）或機台老虎鉗的 V 型缺口夾穩', b: '圓柱直接平放工作台，用手按住就好', correct: 'a', explain: '圓柱形工件一旦被鑽頭咬住會瞬間高速旋轉。V 型槽或 V 型鉗口能讓圓柱卡進 V 型溝不轉動，是鑽圓柱的標準固定方式。' },
