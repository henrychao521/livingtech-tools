// 3D 印表機 模組 2：安全闖關
const SCENARIOS = [
  { q: '列印中發現首層沒附著（在亂跑），下一步？', a: '繼續列印看會不會自己好', b: '立刻按暫停，重新校正熱床', correct: 'b', explain: '首層沒附著代表噴頭與熱床距離不對。繼續印只會浪費料 + 噴頭被纏成一坨。應立刻停止重新校正。' },
  { q: '想換絲線，正確順序？', a: '加熱噴頭到列印溫度 → 抽出舊絲 → 推入新絲 → 擠出一段確認顏色', b: '直接拉舊絲、塞新絲', correct: 'a', explain: '冷拉絲線會讓殘留塑料卡在加熱頭內造成堵料。一定要加熱到熔點才能拉。' },
  { q: '剛列印完的物件，多久才能徒手摸熱床？', a: '立刻就能摸（已停止加熱）', b: '等到 LCD 顯示溫度 < 40°C 才摸', correct: 'b', explain: '熱床從 60°C 降到 40°C 約需 5 分鐘。即使「停止加熱」按下，餘溫還是會燙人。' },
