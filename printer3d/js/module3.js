...
const STEPS = [
  ...
  { title: '熱床校正', desc: '預熱熱床到列印溫度 → 將噴頭手動移到四角 → 用 A4 紙確認摩擦阻力 → 微調螺絲。某些機型有自動調平。', tip: 'A4 紙能略微通過、有阻力是最佳距離（約 0.1mm）。', warn: '校正不準是「首層失敗」最大原因。', anim: 'calibrate' },
  { title: '預熱噴頭與熱床', desc: 'PLA：噴頭 200°C / 熱床 60°C\nPETG：噴頭 240°C / 熱床 80°C\nABS：噴頭 250°C / 熱床 100°C', tip: '可在切片時順便預熱，等到列印開始溫度也達標。', warn: null, anim: 'heat' },
