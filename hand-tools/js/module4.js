...
const QUIZ = [
  ...
  { task: '鎖一顆 M6 內六角螺絲', icon: '🔧',
    ...
    explain: '「內六角」螺絲頭凹槽是六角形，必須用六角扳手（Allen key）；尺寸依螺絲規格選 — M6 一般對應 4 mm。一字起子與外側扳手無法咬合內六角凹槽。',
    cite: '[1][7]' },

  { task: '量測一個小金屬塊外徑 12.5 mm 是否符合圖面', icon: '📏',
    ans: '游標卡尺',
    options: ['直尺', '捲尺', '游標卡尺', '角尺'],
    explain: '0.1 mm 級的尺寸需要游標卡尺（解析度可達 0.02 mm）。直尺最小刻度通常為 0.5 mm 誤差過大；捲尺更粗；角尺只能量直角。',
    cite: '[2]' },
