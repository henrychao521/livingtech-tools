// 能源系統 模組 1：5 種能源
const ENERGIES = [
  { id: 'fossil', name: '化石燃料 Fossil', icon: '🛢', renewable: false, tw_share: '81%', co2: '~900 g/kWh',
    desc: '煤、石油、天然氣——上億年前生物遺骸經高壓高溫形成。台灣 2024 年仍佔總發電 81%（燃煤 43% + 燃氣 38%）。',
    pros: '能量密度高、技術成熟、發電穩定', cons: '不可再生、高 CO₂ 排放、空汙、價格波動' },
  { id: 'nuclear', name: '核能 Nuclear', icon: '☢', renewable: false, tw_share: '5%', co2: '~12 g/kWh',
    desc: '鈾-235 核分裂釋放熱能→水變蒸汽→推動渦輪發電。台灣目前 1 部核三 2 號機運轉中（2025 將除役）。',
    pros: '碳排極低、發電穩定、能量密度極高', cons: '核廢料 10 萬年才衰變、災難風險、輿論爭議' },
  { id: 'solar', name: '太陽能 Solar', icon: '☀', renewable: true, tw_share: '~5%', co2: '~45 g/kWh',
    desc: '光伏（PV）效應—光直接轉電。台灣日照豐沛，2024 年太陽能裝置量達 14GW，是再生能源主力。',
    pros: '無燃料費、零汙染、可建在屋頂', cons: '效率僅 20-22%、需大面積、看天吃飯' },
  { id: 'wind', name: '風力 Wind', icon: '🌬', renewable: true, tw_share: '~2%', co2: '~11 g/kWh',
    desc: '風能推動風機葉片→帶動發電機。台灣海峽風場世界級，2024 年離岸風電開始大規模商轉。',
    pros: '台灣海峽風能豐沛、效率較太陽能高', cons: '颱風損壞、低頻噪音、鳥類撞擊' },
  { id: 'hydro', name: '水力 Hydro', icon: '💧', renewable: true, tw_share: '~1.5%', co2: '~24 g/kWh',
...
ENERGIES.forEach(e => {
  ...
  card.innerHTML = `
    <div style="display:flex;align-items:center;gap:10px;margin-bottom:8px"><span style="font-size:32px">${e.icon}</span><h4 style="margin:0;color:#854D0E">${e.name}</h4></div>
