  ...
  function buildDisc(el) {
    el.innerHTML = `
      <div style="background:#fef2f2;border:1px solid #fecaca;border-radius:8px;padding:10px 14px;margin-bottom:12px;display:flex;flex-wrap:wrap;gap:8px">
        <span style="background:#dc2626;color:#fff;padding:3px 10px;border-radius:12px;font-size:12px;font-weight:700">⚠ 工件只能放在右半邊（向下旋轉側）！</span>
      ...
      <p style="font-size:13px;color:#374151;margin-bottom:8px">點擊砂盤的<strong style="color:#16a34a">右半邊（綠色，向下旋轉）</strong>或<strong style="color:#dc2626">左半邊（紅色，向上旋轉）</strong>放置工件，觀察結果。</p>
