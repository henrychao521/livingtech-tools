...
const QUIZ_CASES = [
  ...
  { situation: '木板磨到中段時，工件表面突然出現一塊黑色斑點，聞到焦味。', options: ['燒焦痕', '粉塵爆炸', '塑料熔融'], correct: 0, explain: '燒焦痕。工件在砂帶某一點停留太久，摩擦熱無法散去。要保持持續移動、加快進料速度。' },
  ...
  { situation: '砂磨 PVC 塑料邊緣時，表面變黏、冒煙、有刺鼻味。', options: ['塑料熔融', '燒焦痕', '不均勻'], correct: 0, explain: '塑料熔融。PVC 受熱會釋放氯化氫毒氣。立刻停機、開窗通風、戴口罩離開現場。塑料用較粗粒度短時間磨。' },
  { situation: '工件磨完後本來該是直角的邊緣變成圓弧形。', options: ['邊角磨圓', '燒焦痕', '深紋未消'], correct: 0, explain: '邊角磨圓。工件沒平貼靠尺、邊緣施力過大造成。磨邊緣時要把工件抬起，不要在邊緣停留；想保直角用平移方式磨。' },
];
