...
const FAULTS = [
  ...
  { name: '塑料熔融（Plastic Melting）', symptom: '砂磨塑料時表面變黏、冒煙、聞到刺鼻味，砂帶被塑料糊住。', cause: '塑料軟化溫度低（PVC 約 80°C、ABS 約 105°C 即開始軟化），砂磨摩擦熱輕易達到。粒度太細也容易積熱。', fix: '1. 塑料用較粗粒度（120–180）短時間磨\n2. 加快進料速度\n3. 改用銼刀或刨刀處理\n4. PVC/ABS 高溫釋有毒氣，聞到味道立刻停', icon: '🌡', color: '#dc2626' },
