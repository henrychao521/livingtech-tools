// 液壓手臂 模組 2：4 軸結構
const AXES = [
  { id: 'base', name: '軸 1：基座旋轉', icon: '🔄', desc: '手臂繞垂直軸 360° 旋轉。控制方式：兩個針筒交替推/拉，透過齒條把直線運動轉成旋轉。', range: '0° ~ 360°', diff: '可用旋轉接頭（rotary joint）+ 雙針筒，學生實作較難。' },
  { id: 'shoulder', name: '軸 2：大臂上下', icon: '⬆', desc: '大臂繞肩關節上下擺動。控制方式：大針筒一端固定底座，另一端固定大臂中段。推針筒 → 大臂抬起。', range: '0° ~ 90°', diff: '油壓缸越遠離關節，槓桿放大力越多。' },
  { id: 'elbow', name: '軸 3：小臂彎曲', icon: '↗', desc: '小臂繞肘關節彎曲。控制方式：油壓缸接在大臂下方，推動小臂。', range: '-30° ~ 120°', diff: '小臂太長重心問題大，建議比大臂略短。' },
  { id: 'gripper', name: '軸 4：夾爪開合', icon: '🦞', desc: '兩個夾爪開合抓物體。控制方式：油壓缸推動夾爪鉸接點，靠連桿傳動兩夾爪同步開合。', range: '0 ~ 60mm 開合', diff: '夾爪過硬會把脆物體壓碎；過軟抓不住。實作可用彈簧調軟硬。' },
];
...
AXES.forEach(a => {
  ...
  c.innerHTML = `<div style="display:flex;align-items:center;gap:10px;margin-bottom:8px"><span style="font-size:30px">${a.icon}</span><h4 style="margin:0;color:#075985">${a.name}</h4></div>
