...
const QUIZ = [
  ...
  { situation: '紙橋中央承重時，下方先看到紙裂開，上方看到紙皺起，最後從中央折斷。', options: ['彎矩失效', '挫屈', '剪切'], correct: 0, explain: '彎矩失效。中央受力樑的典型——下方受張、上方受壓。要加深樑（高度比寬度有效）或改成桁架。' },
  { situation: '紙橋的桿件完好，但兩根桿子相交的位置膠水裂開，整座橋散架。', options: ['節點脫開', '挫屈', '塑性變形'], correct: 0, explain: '節點脫開。膠水接合面積太小造成。要增大膠水面積，或加三角夾片補強，或加釘子。' },
  { situation: '結構塔做完後 30 分鐘，重心慢慢往一邊歪倒。', options: ['基礎沉陷', '共振', '疲勞'], correct: 0, explain: '基礎沉陷或重心不穩。實際結構是地基不均勻沉陷（如比薩斜塔），紙塔則是黏合慢慢變形。' },
  { situation: '橋樑在交通震動下使用 50 年後突然斷裂，平時看不出異狀。', options: ['疲勞', '剪切', '塑性變形'], correct: 0, explain: '疲勞。反覆應力造成內部裂紋累積，最後突然斷。橋、飛機翼、機械軸都是高風險，要定期檢測。' },
];
