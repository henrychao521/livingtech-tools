...
const QUIZ = [
  ...
  { q: '電動鋸的鋸條快速上下動', options: ['往復運動', '旋轉運動', '間歇運動'], correct: 0, explain: '沿直線上下來回 = 往復。馬達旋轉透過曲柄滑塊變成此運動。' },
  { q: '汽車空調壓縮機（氣冷機）', options: ['曲柄滑塊', '齒輪', '凸輪'], correct: 0, explain: '活塞在氣缸內壓縮空氣 = 曲柄滑塊機構，把皮帶輪旋轉變成活塞往復。' },
  { q: '機械手錶的秒針一秒跳一格', options: ['間歇運動', '旋轉運動', '擺動運動'], correct: 0, explain: '動停動停 = 間歇。手錶用「擒縱機構」（棘輪變種）實現。' },
  { q: '挖土機的鏟斗開合', options: ['四連桿', '凸輪', '螺旋'], correct: 0, explain: '液壓缸推連桿做出弧形軌跡 = 四連桿機構。' },
  { q: '電風扇葉片旋轉送風', options: ['旋轉運動', '擺動運動', '往復運動'], correct: 0, explain: '繞馬達軸做圓周運動 = 純旋轉。注意：搖頭風扇的「左右擺頭」才是擺動。' },
  { q: '腳踏車鏈條傳動', options: ['鏈條（皮帶族）', '齒輪', '曲柄滑塊'], correct: 0, explain: '前後齒盤用鏈條連接傳動 = 鏈條機構。鏈條無滑差，特別適合腳踏車。' },
  { q: '塑膠射出成型機把塑料推進模具', options: ['曲柄滑塊 / 螺桿', '凸輪', '四連桿'], correct: 0, explain: '螺桿旋轉推進塑料 + 油壓缸推進整組 = 螺桿（螺旋）+ 曲柄滑塊組合。' },
];
